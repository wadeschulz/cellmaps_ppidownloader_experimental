...
# -*- coding: utf-8 -*-
#
# cellmaps_ppidownloader documentation build configuration file, created by
...
init_file = os.path.join('..', 'cellmaps_ppidownloader', '__init__.py')
...
latex_documents = [
    (master_doc, 'cellmaps_ppidownloader.tex',
     u'cellmaps_ppidownloader Documentation',
     u'Gege Qian', 'manual'),
]
...
man_pages = [
    (master_doc, 'cellmaps_ppidownloader',
     u'cellmaps_ppidownloader Documentation',
     [author], 1)
]
